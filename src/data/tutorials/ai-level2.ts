...
export const aiLevel2: Tutorial[] = [
  {
    ...
    sections: [
      ...
      {
        title: "Data augmentation — अधिक उदाहरणे",
        content: "फोटोचे नमुने वाढवण्याची सोपी युक्ती — data augmentation.\n\nसाधी उदाहरणे:\n\t• चित्र थोडे फिरवणे (rotate ±15°).\n\t• आडवे उलटणे (flip).\n\t• Zoom / crop — वेगवेगळे कोपरे.\n\t• Brightness/color जरा बदलणे.\n\nपरिणाम: एक फोटो अनेक आवृत्त्यांत बदलून मॉडेलला वेगवेगळ्या पद्धतीचे नमुने शिकता येतात.\n\nउदाहरण: 1000 मांजर फोटो → augmentation ने 5000 शिक्षणाची उदाहरणे.\n\nका महत्त्वाचे:\n\t• overfitting कमी होते — मॉडेल 'ठराविक' कोनातच नसून सर्वत्र चांगले.\n\t• लहान data मध्ये विविधता निर्माण होते.\n\nसावधान: वास्तविक वापरातील विविधतेशी मेळ घालणारे नियम शोधा — टोकाची विकृती (extreme) उपयुक्त नसते.",
      },
      {
        title: "Transfer learning — तयार मॉडेल वापरणे",
        content: "लाखो फोटोंवर शिकलेले मॉडेल नवीन कामासाठी पुन्हा वापरता येते — याला transfer learning म्हणतात.\n\nपद्धत:\n\t१. तयार मॉडेल घ्या (उदा. ResNet — मोठ्या ImageNet data वर शिकलेले).\n\t२. शेवटचे काही layers वेगळे करा.\n\t३. तुमच्या (लहान) dataset वर नवीन classification layer शिकवा.\n\nफायदे:\n\t• कमी data पुरेसे — 100-1000 चित्रे.\n\t• कमी वेळ आणि संगणक.\n\t• 'चित्रे कशी हाताळायची' हे ज्ञान आधीच शिकलेले असते.\n\nउदाहरण: रेल्वे स्थानकाची मराठी चिन्हे ओळखणे — तयार मॉडेलवर थोडे प्रशिक्षण.\n\nसोपी ओळख: फक्त 'शेवटची शिकवणूक' आपल्या कामासाठी — बाकी ज्ञान मोठ्या dataset वरून. व्यवहारात बहुतेक सर्व image models हेच करतात.",
      },
      {
        title: "लहान data हाताळणे — व्यावहारिक सल्ला",
        content: "कधीकधी dataset खूप लहान असतो — इथे काय करायचे?\n\nलहान data उपाय:\n\t• Augmentation — वर पाहिल्याप्रमाणे.\n\t• Transfer learning — तयार मॉडेल.\n\t• Simple model — जास्त complex तंत्र नको.\n\t• Regularization — overfit टाळण्यासाठी.\n\nसामान्य चुका:\n\t• जादा layers/params — छोट्या data वर overfit.\n\t• Test data वारंवार तपासणे — खोटी परीक्षा.\n\t• फक्त accuracy पाहणे — bias पण तपासा.\n\nनियम: dataset जितका लहान, तितका सोपा मॉडेल आणि अधिक सावध evaluation.\n\nशिकण्याच्या दृष्टीने लहान प्रकल्प चांगले — संपूर्ण चक्र (data → model → test) एकदा पूर्ण होऊन आत्मविश्वास वाढतो. मग मोठा data हाताळता येतो.",
      },
      {
        title: "आजचा सारांश",
...

  {
    ...
    sections: [
      ...
      {
        title: "Transparency — AI कसे स्पष्ट करतात",
        content: "AI चे निर्णय समजण्याची क्षमता — transparency. काळ्या पेटीसारखे मॉडेल (black-box) संशयास्पद असते.\n\nका महत्त्वाचे:\n\t• भरती/कर्ज/आरोग्य — वापरकर्त्याला कारण समजते.\n\t• चुकीचे कारण ओळखता येते.\n\t• नियम आणि न्याय — स्पष्टीकरणाचा हक्क.\n\nसोपे मार्ग:\n\t• Linear model — गुणांक थेट दिसतात.\n\t• Decision tree — वाचायला सोपे निर्णय नियम.\n\t• LIME/SHAP — complex मॉडेलचे स्पष्टीकरण.\n\nउदाहरण: कर्ज नाकारल्यावर 'उत्पन्न कमी' असे कारण सांगणे योग्य.\n\nव्यापार: अचूकता आणि स्पष्टता यात तडजोड असू शकते; पण महत्त्वाच्या निर्णयांत स्पष्टता प्राधान्य. हे AI विकसकांचेच कर्तव्य आहे.",
      },
      {
        title: "नियम आणि कायदे — जगभरातील धोरणे",
        content: "AI साठी आता कायदेशीर नियम तयार होत आहेत — त्यांची ओळख आवश्यक.\n\nEU AI Act (२०२४) — धोक्याच्या पातळीवर AI वर्गीकरण:\n\t• अस्वीकार्य — धोकादायक वापर बंद.\n\t• उच्च जोखीम — कठोर तपासणी.\n\t• कमी जोखीम — स्पष्ट माहिती.\n\nभारतात:\n\t• MeitY 'Responsible AI' मार्गदर्शक तत्त्वे.\n\t• डेटा संरक्षण कायदा (DPDP Act 2023) — data गोळा करताना संमती.\n\nसोपे नियम:\n\t• वापरताना स्थानिक नियमांची माहिती ठेवा.\n\t• खासगी data / मुलांचा data — संमती आणि काळजी.\n\t• महत्त्वाच्या निर्णयांवर मानवी पडताळणी.\n\nकायदे देशानुसार वेगळे; व्यवसाय करताना स्थानिक नियम तपासणे आवश्यक.",
      },
      {
        title: "AI आणि नोकरी — संतुलित दृष्टी",
        content: "'AI मुळे नोकरी जाईल' — ही भीती खरी पण निम्मी.\n\nकाय बदलेल:\n\t• पुनरावृत्ती करणाऱ्या कामांतील माणसाचा वेळ कमी होईल.\n\t• नवीन भूमिका — AI सह काम करण्याच्या (AI-augmented).\n\t• Prompt writing, data, safety या कौशल्यांची मागणी वाढेल.\n\nकाय टिकेल:\n\t• मानवी निर्णय, सहानुभूती, creativity.\n\t• संदर्भ व नियम समजून घेणे.\n\nमदत करणारी युक्ती:\n\t• सध्याची कौशल्ये वाढवा (reskill/upskill).\n\t• AI साधने शिकून काम गतीने करा.\n\t• adapt — बदलत्या बाजारानुसार.\n\nहा धडा: तंत्रज्ञान टाळण्यात उत्तर नाही — ते कुशलतेने वापरून पुढे जाणे प्रभावशाली. ऐतिहासिक दृष्टी: calculator ने गणना सोपी केली, गणित संपले नाही.",
      },
      {
        title: "आजचा सारांश",
...

  {
    ...
    sections: [
      ...
      {
        title: "Free vs Paid — तुलनेचे मापदंड",
        content: "AI साधने free आणि paid दोन्ही उपलब्ध — कशाची निवड कराल हे जाणूनबुजून करा.\n\nमापदंड:\n\t• क्षमता — free मध्ये फक्त मूलभूत काम (कोट्यांक, वेळ, आकार).\n\t• वेग — paid चे व्यस्त काळात जलद.\n\t• Privacy — free tool व्यावसायिक data साठी योग्य नाही.\n\t• Updates — नवीन वैशिष्ट्ये प्रथम paid वर.\n\t• किंमत — वापरानुसार payable.\n\nसल्ला:\n\t• सुरुवात free ने करा — काय योग्य ते कळेल.\n\t• व्यवसायासाठी paid चे वेळ/सुरक्षा मूल्यवान.\n\t• तुमच्या कार्याच्या आधारेच निवड — सर्वात महाग तीच सर्वोत्तम नाही.\n\nएक प्रयोग: वेगवेगळ्या साधनांत समान काम करा आणि निकालांची तुलना लिहा. निवड तुमचीच.",
      },
      {
        title: "प्रॉम्प्ट लायब्ररी — सामान्य कामांचे टेम्पलेट",
        content: "ai-prompts पाठात prompt च्या कला पाहिल्या. आता सामान्य कामांसाठी तयार टेम्पलेट:\n\nसारांश:\n\t'खालील मजकूर ५ ओळींत सारांश करा, मुख्य मुद्दे गाठा: {मजकूर}'\n\nभाषांतर:\n\t'मराठीतून इंग्रजीत भाषांतर, सुटसुटीत भाषा: {मजकूर}'\n\nसोपे समजावणे:\n\t'हे संकल्प १० वर्षांच्या मुलास ३ ओळींत समजाव: {संकल्पना}'\n\nकोड स्पष्टीकरण:\n\t'या कोडचे काम आणि प्रत्येक ओळीचा अर्थ सांगा: {कोड}'\n\nहे टेम्पलेट्स वापरून वेळ वाचतो आणि निकाल सुधारतात. स्वतः प्रयोग करून अधिक जोडा — प्रत्येक प्रयोगाची नोंद ठेवा. Prompt हेच AI वापराचे core कौशल्य.",
      },
      {
        title: "टूल मर्यादा — कशासाठी वापरू नये",
        content: "AI साधने शक्तिशाली पण अचूक नाहीत. काही वापरात सावधगिरी आवश्यक:\n\nटाळावे:\n\t• वैद्यकीय निदान — एकट्याने नाही.\n\t• कायदेशीर सल्ला — संदर्भ विचारात नसल्यास.\n\t• संवेदनशील वैयक्तिक data.\n\t• अचूक गणना/इतिहास data.\n\nजागरूक रहा:\n\t• नेहमी तपासा — मोठी माहिती अनेक स्रोतांतून सत्यापित करा.\n\t• स्रोत कळत नाही तिथे सावधान.\n\t• कॉपीराइट — निर्मिती मूळ माणसाची असल्याची काळजी.\n\nसाधे सूत्र: AI चे उत्तर ही सूचना (suggestion) आहे, सत्याचा निर्णय नाही. जबाबदार वापर म्हणजे आपला विचार मागे न ठेवता AI सहाय्य घेणे.",
      },
      {
        title: "आजचा सारांश",
...

  {
    ...
    sections: [
      ...
      {
        title: "पोर्टफोलिओ — प्रकल्प दाखवणे",
        content: "AI नोकरीत प्रवेश घेण्यासाठी प्रमाणपत्रांहून जास्त 'काय बनवले' हे महत्त्वाचे — तोच पोर्टफोलिओ.\n\nकाय ठेवावे:\n\t• २-३ पूर्ण प्रकल्प (चांगले २ पूर्ण हे १० अर्धवटांहून जास्त).\n\t• प्रत्येकात: समस्या, data, मॉडेल, निकाल.\n\t• code GitHub वर उपलब्ध.\n\t• एक लहान demo / screenshots.\n\nउदाहरण प्रकार:\n\t• Spam detector (या कोर्सचा प्रकल्प).\n\t• घर किंमत अंदाज (regression).\n\t• मराठी sentiment analysis.\n\nमुलाखतीत:\n\t• प्रकल्पाची प्रक्रिया सांगा — data कसा मिळवला, कशी स्वच्छता, कोणत्या चुका.\n\t• दाखवा की समस्या-सोडवणे येते.\n\nपोर्टफोलिओ हेच सगळ्यात मजबूत resume — ते प्रात्याक्षिक असते.",
      },
      {
        title: "समुदाय आणि मेंटर — वाढीसाठी",
        content: "एकट्याने शिकण्यापेक्षा समुदाय आणि मार्गदर्शक (mentor) सोबत शिकणे अधिक फलदायी.\n\nसमुदाय:\n\t• GitHub — open source contributions.\n\t• Kaggle — competitions, datasets, forum.\n\t• Telegram/Discord गट — मराठी AI चर्चा.\n\t• स्थानिक meetups / hackathons.\n\nमेंटर:\n\t• अनुभवी व्यक्तीचा सल्ला — चुका टाळता येतात.\n\t• प्रकल्पांची प्रतिक्रिया.\n\t• नेटवर्किंग — कामाच्या संधी.\n\nसुरुवात कशी:\n\t• प्रश्न विचारण्याची भीती घालवा — सर्व सुरुवातीपासून होते.\n\t• स्वतः शिकून छोटा प्रकल्प शेअर करा.\n\t• मदत देण्यासही तयार रहा — उलटही फायदा.\n\nतांत्रिक कौशल्य + नेटवर्क दोन्ही मिळूनच खरी वाढ होते.",
      },
      {
        title: "मराठीत AI — स्वदेशी उपक्रम",
        content: "AI शिकण्यासाठी मराठीत साधने वाढत आहेत — त्यांचा फायदा घ्या:\n\nस्रोत:\n\t• marath.ai सारखे मंच — मराठीत AI चर्चा.\n\t• मराठी corpus — भाषा मॉडेल्सचा पाया.\n\t• Government भारतीय भाषा AI उपक्रम.\n\t• स्थानिक meetups — पुणे/मुंबई AI गट.\n\nतुमचे योगदान:\n\t• मराठी blog/video वर शिकलेले शेअर करा.\n\t• मराठी data संकलन उपक्रमांत सहभाग.\n\t• स्वदेशी dataset तयार करून मदत करा.\n\nफायदा: एकीकडे शिकणे, दुसरीकडे समुदाय वाढवणे. English तांत्रिक माहिती आवश्यक, पण मराठीत समजणे जास्त सखोल.\n\nहे असे क्षेत्र आहे जिथे तुम्ही शिकून भारतीय AI परिसंस्थेला योगदान देऊ शकता.",
      },
      {
        title: "आजचा सारांश",
...

  {
    ...
    sections: [
      ...
      {
        title: "कोड एकत्र — संपूर्ण प्रवाह एका नजरेत",
        content: "आतापर्यंतच्या पायऱ्या एकत्र करून संपूर्ण spam detector एका दृष्टीत:\n\nfrom sklearn.feature_extraction.text import CountVectorizer\nfrom sklearn.naive_bayes import MultinomialNB\nfrom sklearn.model_selection import train_test_split\nfrom sklearn.metrics import accuracy_score\n\n# data\nmessages = [('मोफत बक्षीस मिळवा', 'spam'), ('उद्या मीटिंग', 'ham'), ...]\nX = [m for m, _ in messages]\ny = [1 if l == 'spam' else 0 for _, l in messages]\n\n# features\nvec = CountVectorizer()\nX_vec = vec.fit_transform(X)\n\n# model\nX_train, X_test, y_train, y_test = train_test_split(X_vec, y, test_size=0.2)\nmodel = MultinomialNB()\nmodel.fit(X_train, y_train)\n\n# test\npred = model.predict(X_test)\nprint('accuracy:', accuracy_score(y_test, pred))\n\nही चार पायरी — features बनवणे, विभागणी, model, evaluation — सार्वत्रिक. कोडच्या रचनेत ५-६ ओळींत कोर मॉडेल तयार.\n\nकोणताही AI प्रोजेक्ट याच चौकटीत बसतो — फक्त data आणि algorithm बदलतो.",
      },
      {
        title: "अधिक data — मोठे spam corpus",
        content: "वास्तविक जगात spam data हजारो/लाखो संदेशांचा असतो. मोठ्या corpus मध्ये मात्र:\n\n\t• आणखी विविधता — नवीन शब्द, फसवणूकीच्या युक्त्या.\n\t• लिंक/फोन नंबर/इमोजीचे नमुने.\n\t• कालांतराने नवीन spam पद्धती.\n\nमोठ्या data साठी उपाय:\n\t• अधिक capable क्लासिफायर.\n\t• TF-IDF + n-grams चा वापर.\n\t• नवीन messages जोडण्याची पद्धत तयार करणे.\n\nउदाहरण स्रोत: तुमच्या email चे spam folder, open datasets (SMS Spam Collection इ.).\n\nपण मोठा data म्हणजे स्वच्छ data — हे विसरू नका. स्वच्छता, labeling, विविधता या तिन्ही महत्त्वाच्या. मॉडेलची खरी परीक्षा नवीन messages वरच असते.",
      },
      {
        title: "आजचा सारांश",
...

  {
    ...
    sections: [
      ...
      {
        title: "Intent detection — हेतू ओळखणे",
        content: "चॅटबॉटच्या गाभ्यामध्ये intent detection असते — वापरकर्त्याचा हेतू ओळखणे.\n\nउदाहरण हेतू:\n\t• greeting (नमस्कार)\n\t• fare_query (किंमत)\n\t• order_status (ऑर्डर स्थिती)\n\t• help (मदत)\n\nसोपी पद्धत: keywords ओळखणे.\n\t• 'किंमत', 'किती रुपये' → fare_query.\n\nपुढील स्तर: मशीन लर्निंग.\n\t• प्रत्येक message + intent label — dataset.\n\t• CountVectorizer + MultinomialNB (spam पाठातील तंत्र).\n\t• नवीन message → वर्गीकरण.\n\nमर्यादा: keywords एकटे पुरेसे नाहीत (व्यंगात्मक भाषा). Rule + ML मिश्रण सर्वोत्तम.\n\nहेच concept बहुतेक सर्व आधुनिक chatbots — Alexa, Siri — मध्ये आहे, फक्त अधिक capable models सह.",
      },
      {
        title: "State machine — संभाषणाचा प्रवाह",
        content: "चॅटबॉट एका प्रश्न-उत्तरापुरते मर्यादित असतो; पण संभाषण बदलते तेव्हा state machine लागते.\n\nState = संभाषणातील सध्याचा टप्पा.\n\nउदाहरण — ऑर्डर स्थिती:\n\t• State A: नमस्कार — काय हवे.\n\t• State B: किंमत विचारणा.\n\t• State C: ऑर्डर क्रमांक विचारणा.\n\nप्रत्येक state मध्ये user च्या प्रतिसादानुसार पुढील state वर जातो. चुकीचे उत्तर दिले तर त्याच state मध्ये राहतो.\n\nकोड रचना:\n\t• state = 'greeting'\n\t• if state == 'asking_price' and message contains number: state = 'confirm'\n\nफायदा: संभाषण व्यवस्थित, वापरकर्ता डोक्यात येतो. मर्यादा: पूर्वनिर्धारित मार्ग, अपेक्षित उत्तरे आवश्यक.\n\nसुरुवात सोप्या state machine ने; नंतर intent + policy ने गहन.",
      },
      {
        title: "Memory — संदर्भ ठेवणे",
        content: "संभाषणात वापरकर्त्याने आधी सांगितलेली माहिती लक्षात ठेवणे — memory.\n\nउदाहरण:\n\t• User: 'माझा फोन २ जीबी रॅमचा आहे.'\n\t• User: '४ जीबी वर सुधारणा किती?'\n\t• चॅटबॉट: आधी सांगितलेला आकडा लक्षात ठेवून उत्तर देतो.\n\nकोडभागी:\n\t• session_data = {}\n\t• session_data['ram'] = '२ जीबी'\n\t• नवीन प्रश्नावर session_data वाचून उत्तर.\n\nमर्यादा: फक्त संभाषणातील माहिती; कालांतरातील आठवण नाही. ती database मध्ये साठवावी लागते.\n\nआधुनिक chatbots (ChatGPT) संपूर्ण संदर्भात संभाषण प्रक्रिया करतात — पण आतासाठी आपल्या सोप्या chatbot ला session memory पुरेसी.\n\nमुख्य धडा: memory म्हणजे फक्त data संचय नाही; कोणती माहिती कधी वापरायची हे ठरवणेही तितकेच महत्त्वाचे.",
      },
      {
        title: "आजचा सारांश",
