...
@container (min-width: 450px) {
  ...
  container-type: inline-size;
    ...
    related: ["css-responsive-table", "css-fluid-typography", "css-media-queries-basics"],
...
@supports (background: color-mix(in srgb, red, white)) {
  ...
  background: color-mix(in srgb, #0d9488 90%, black);
    ...
    related: ["css-oklch-color", "css-colors-background", "css-design-system"],
...
@supports (color: oklch(0.7 0.15 160)) {
  ...
  background: oklch(0.65 0.18 180);
    ...
    related: ["css-color-mix", "css-design-system", "css-root-custom"],
    prev: "css-color-mix",
    next: "css-light-dark",
    levelLabel: CSS14_LABEL,
  },
...
body {
  background: light-dark(white, #0f172a);
    ...
    related: ["css-prefers-media", "css-colors-background", "css-design-system"],
...
@scope (.card) {
  ...
  h2 {
    ...
    related: ["css-cascade-keywords", "css-cascade-layers", "css-specificity-tips"],
    prev: "css-light-dark",
    next: "css-text-wrap",
    levelLabel: CSS14_LABEL,
  },
...
p {
  ...
  text-wrap: balance;
    ...
    related: ["css-typography", "css-text-spacing", "css-fluid-typography"],
    prev: "css-scope-rule",
...
.card-list .card {
  ...
  *::after {
  ...
  .banner {
    ...
    related: ["css-light-dark", "css-animation-easing", "css-accessibility"],
    prev: "css-subgrid",
