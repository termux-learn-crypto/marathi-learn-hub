    ...
    sections: [
      {
        ...
        content: "✗ जोखमी: गलिच्छ data → अन्यायकारक निर्णय (bias); छायाचित्रे data मध्ये जातात (privacy); बनावट फोटो/आवाज; काही नोकर्या बदलतात.\n✗ AI टाळावा असा नाही, तर जाणूनबुजून वापरावा.\nप्रत्येक चुकीचा उपाय आधीच वाचल्याने पुढील प्रयोगांमध्ये तुम्हाला ती चुक टाळता येईल.",
      },
...
practiceQuestions: [
      "आर्टिफिशियल इंटेलिजन्स चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "आर्टिफिशियल इंटेलिजन्स वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
    ...
    
      {
        ...
        options: ["आर्टिफिशियल इंटेलिजन्स", "Portal Nexus — दृश्य संग्रह", "इलेक्ट्रॉनिक्सची मूलभूत संकल्पना", "स्थान — घटक कुठे उभा"],
        correct: 0,
      },
],
  ...
  },
{
    ...
    sections: [
      {
        title: "मशीन लर्निंग म्हणजे काय?",
        content: "Machine Learning म्हणजे संगणकाला data वरून शिकायला शिकवणे.\nML हे AI चे उप-क्षेत्र आहे.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "का शिकावे? मशीन लर्निंग चे फायदे आणि महत्त्व",
        content: "✓ Dimensionality reduction: हजारो features मधून गरजेचे २-३ बनवणे.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
        content: "✗ सुरुवातीला weight random — अंदाज चुकीचे.\n✗ चुक मोजा.\n✗ अनेक फेऱ्यांनंतर चुक कमीत कमी.\n✗ चुक magnitude ने मोजली जाते.\n✗ चुक चुकीच्या वर्गावरून मोजली जाते.\nप्रत्येक चुकीचा उपाय आधीच वाचल्याने पुढील प्रयोगांमध्ये तुम्हाला ती चुक टाळता येईल.",
      },
...
practiceQuestions: [
      "मशीन लर्निंग चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "मशीन लर्निंग वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
      "ह्या धड्यातून तुम्हाला नेमकी कोणती एक गोष्ट नवी समजली ती लिहा.",
    ],    quiz: [
      {
      ...
      {
        question: "ह्या धड्यात मुख्य विषय कोणता?",
        options: ["मशीन लर्निंग", "mix-blend-mode — रंग मिश्रण", "Overriding - पद्धती सुधारणे", "Protocol — HTTP/2 आणि HTTP/3"],
        correct: 0,
      },
],
  ...
  },
{
    ...
    sections: [
      {
        title: "AI बनवण्यासाठी Python का म्हणजे काय?",
        content: "Python ही AI/ML साठी सर्वात लोकप्रिय भाषा - का ते पाहू.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "का शिकावे? AI बनवण्यासाठी Python का चे फायदे आणि महत्त्व",
        content: "✓ C++: int sum = 0; for (int i=0; i<5; i++) sum += i;\nPython: sum(range(5))\n\nAI data वर काम करताना वेगवान write व पुन्हा वापर महत्त्वाचा — Python तसे शक्य करते.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
...
practiceQuestions: [
      "AI बनवण्यासाठी Python का? चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "AI बनवण्यासाठी Python का? वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
      "ह्या धड्यातून तुम्हाला नेमकी कोणती एक गोष्ट नवी समजली ती लिहा.",
    ],    quiz: [
      {
      ...
      {
        question: "ह्या धड्यात मुख्य विषय कोणता?",
        options: ["AI बनवण्यासाठी Python का", "var — पडझड नियम", "DHT11 + ESP — तापमान/आर्द्रता वाचन, web मध्ये दाखवणे, ThingSpeak cloud", "Advanced Project - लायब्ररी व्यवस्थापन"],
        correct: 0,
      },
],
