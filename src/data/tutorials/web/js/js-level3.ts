...
export const JS3_LABEL = "JS · Level 3 — String, Array आणि Function";

export const jsLevel3: Tutorial[] = [
  {
    slug: "js-methods",
    categoryId: "web",
    ...
    sections: [
      {
        title: "का शिकावे? String व Array वरची सर्वांत वापरली जाणारी methods चे फायदे आणि महत्त्व",
        content: "✓ जसे जर value string असेल तर val.length ने त्यातल्या अक्षरांची संख्या मिळते — length ही property आहे, म्हणून () ची गरज नाही.\n✓ क्रम महत्त्वाचा — जसं \\\"क्रम नेहमी सारखा\\\" नियम नाही, तर बदल स्पष्ट राहतो.\n✓ मध्यम value तपासायला सोयीचे.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
        content: "✗ नियम लक्षात ठेवा: () असल्यास ती method/function (क्रिया), नसल्यास property (गुणधर्म, value).\nप्रत्येक चुकीचा उपाय आधीच वाचल्याने पुढील प्रयोगांमध्ये तुम्हाला ती चुक टाळता येईल.",
      },
...
console.log(चरण२);`,
    ...
    related: ["js-variables", "js-console", "js-basics"],
    next: "python-functions",
    prev: "js-console",
    levelLabel: JS3_LABEL,
    practiceQuestions: [
