...
export const JS4_LABEL = "JS · Level 4 — निर्णय, लूप आणि याद्या";

export const jsLevel4: Tutorial[] = [
  {
    ...
    sections: [
      {
        title: "निर्णय घेणे — if, else म्हणजे काय?",
        content: "if/else ने code ला निर्णय घेता येतो. तुलना operators आणि condition कशी तपासली जाते.\nआतापर्यंत code वरून-खाली सरळ चालला.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "का शिकावे? निर्णय घेणे — if, else चे फायदे आणि महत्त्व",
        content: "✓ क्रम महत्त्वाचा: सर्वात विशिष्ट/मोठी अट आधी लिहा, नाहीतर छोटी अट पुढे निघून अडथळा आणेल.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
        content: "✗ एकच नियम लक्षात ठेवा: condition फक्त if च्या कंसात लिहितात; else कंस नसतो.\nप्रत्येक चुकीचा उपाय आधीच वाचल्याने पुढील प्रयोगांमध्ये तुम्हाला ती चुक टाळता येईल.",
      },
...
practiceQuestions: [
      "निर्णय घेणे — if, else चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "निर्णय घेणे — if, else वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
    ...
    
      {
        ...
        options: ["निर्णय घेणे — if, else", "dataclasses - सोपी data वस्तू", "घरगुती DIY प्रोजेक्ट्स", "Scroll-driven — हालचाल जोडणी"],
        correct: 0,
      },
],
  ...
  },
  {
    ...
    sections: [
      {
        title: "काम करणारी चिन्हे — Operators म्हणजे काय?",
        content: "+, -, *, /, %, ++, --, assignment आणि तुलना — operators चा पूर्ण परिचय.\nअंकगणित operators आपल्या गणितासारखेच:\n• + बेरीज\n• - वजाबाकी\n• * गुणाकार\n• / भागाकार\n• % भागाकारावर उरलेली रक्कम (remainder)\n• ** घात (power)\nलक्ष द्या: / नेहमी दशांश देते — 7/2 = 3.5.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "का शिकावे? काम करणारी चिन्हे — Operators चे फायदे आणि महत्त्व",
        content: "✓ हे सोयीचे, पण अनपेक्षितही: 1 + 2 + '3' → '33', कारण डावीकडून उजवीकडे — आधी 1+2=3, मग 3+'3'='33'.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
...
practiceQuestions: [
      "काम करणारी चिन्हे — Operators चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "काम करणारी चिन्हे — Operators वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
      "ह्या धड्यातून तुम्हाला नेमकी कोणती एक गोष्ट नवी समजली ती लिहा.",
    ],    quiz: [
      {
      ...
      {
        question: "ह्या धड्यात मुख्य विषय कोणता?",
        options: ["काम करणारी चिन्हे — Operators", "Strings - मजकूर", "निर्णय घेणे — if, else", "HTML Forms"],
        correct: 0,
      },
],
  ...
  },
  {
    ...
    sections: [
      {
        title: "का शिकावे? Numbers आणि Math object चे फायदे आणि महत्त्व",
        content: "\"Numbers आणि Math object\" हा विषय व्यावहारिक जीवनात आणि पुढील शिक्षणात थेट उपयोगी आहे — म्हणून तो क्रमाक्रमाने नीट समजून घेणे महत्त्वाचे आहे.\nहे शिकल्यानंतर तुम्ही स्वतः छोटी उदाहरणे घडवू शकता आणि याच्या पुढील संकल्पना सहजपणे समजून घेऊ शकता.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
        content: "✗ फक्त वाचून पुढे जाणे — वाचनाने समज राहते पण प्रत्यक्ष सराव न झाल्यास आठवण ठाम होत नाही; प्रत्येक उदाहरण स्वतः रन करा.\n✗ निर्णयात घाई करणे — तपशीलात न जाता निष्कर्ष काढल्यास चुकीचा अर्थ बसतो; प्रत्येक संकल्पना क्रमाक्रमाने तपासा.\n✗ परिणाम/आउटपुट न तपासणे — अपेक्षित उत्तराशी तुमचे उत्तर जुळते आहे का हे पाहूनच पुढे जा.\n✗ सर्व एकाच दिवशी संपवण्याची घाई — छोट्या खंडांमध्ये शिका; ताज्या मनाने केलेला अभ्यास अधिक अचूक होतो.\nप्रत्येक चुकीचा उपाय आधीच वाचल्याने पुढील प्रयोगांमध्ये तुम्हाला ती चुक टाळता येईल.",
...
practiceQuestions: [
      "Numbers आणि Math object चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "Numbers आणि Math object वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
      "ह्या धड्यातून तुम्हाला नेमकी कोणती एक गोष्ट नवी समजली ती लिहा.",
    ],    quiz: [
      {
      ...
      {
        question: "ह्या धड्यात मुख्य विषय कोणता?",
        options: ["Numbers आणि Math object", "tokens — भाषा रचना", "Variables — एकदा ठरवा सर्वत्र", "Prompt Engineering — चांगले प्रश्न, चांगले उत्तर (मराठीत)"],
        correct: 0,
      },
],
  ...
  },
  {
    ...
    sections: [
      {
        title: "Math ची special कार्ये म्हणजे काय?",
        content: "Math.round, floor, ceil, trunc, random, max/min, pow, sqrt — प्रत्येकाचा उपयोग.\nचार उदाहरणं एकाच number वर:\n• Math.round(4.5) → 5 (जवळचा)\n• Math.floor(4.9) → 4 (खाली, नेहमी कमी करतो)\n• Math.ceil(4.1) → 5 (वर, नेहमी वाढवतो)\n• Math.trunc(4.9) → 4 (दशांश फक्त कापतो; negative साठी floor # वेगळे)\nनकारात्मक: floor(-4.2) → -5, पण trunc(-4.2) → -4.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "का शिकावे? Math ची special कार्ये चे फायदे आणि महत्त्व",
        content: "✓ हा फरक व्यवहारात महत्त्वाचा.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
        content: "✗ फक्त वाचून पुढे जाणे — वाचनाने समज राहते पण प्रत्यक्ष सराव न झाल्यास आठवण ठाम होत नाही; प्रत्येक उदाहरण स्वतः रन करा.\n✗ निर्णयात घाई करणे — तपशीलात न जाता निष्कर्ष काढल्यास चुकीचा अर्थ बसतो; प्रत्येक संकल्पना क्रमाक्रमाने तपासा.\n✗ परिणाम/आउटपुट न तपासणे — अपेक्षित उत्तराशी तुमचे उत्तर जुळते आहे का हे पाहूनच पुढे जा.\n✗ सर्व एकाच दिवशी संपवण्याची घाई — छोट्या खंडांमध्ये शिका; ताज्या मनाने केलेला अभ्यास अधिक अचूक होतो.\nप्रत्येक चुकीचा उपाय आधीच वाचल्याने पुढील प्रयोगांमध्ये तुम्हाला ती चुक टाळता येईल.",
...
practiceQuestions: [
      "Math ची special कार्ये चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "Math ची special कार्ये वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
      "ह्या धड्यातून तुम्हाला नेमकी कोणती एक गोष्ट नवी समजली ती लिहा.",
    ],    quiz: [
      {
      ...
      {
        question: "ह्या धड्यात मुख्य विषय कोणता?",
        options: ["Math ची special कार्ये", "ThingSpeak full — channel setup, write API, HTTP upload, graphs, mobile अॅप", "skeleton — भार दृश्य", "@layer — क्रम आणि जोडणी"],
        correct: 0,
      },
],
  ...
  },
  {
    ...
    sections: [
      {
        title: "मजकूर हाताळणे — Strings म्हणजे काय?",
        content: "String जोडणे, length, methods (toUpperCase, includes, slice), template literals.\nString म्हणजे अवतरणांमधला मजकूर — \\\"नमस्कार\\\".\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
...
practiceQuestions: [
      "मजकूर हाताळणे — Strings चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "मजकूर हाताळणे — Strings वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
      "ह्या धड्यातून तुम्हाला नेमकी कोणती एक गोष्ट नवी समजली ती लिहा.",
    ],    quiz: [
      {
      ...
      {
        question: "ह्या धड्यात मुख्य विषय कोणता?",
        options: ["मजकूर हाताळणे — Strings", "lang, dir, bdi, bdo, ruby, wbr, meter, progress, dialog", "perf — तेज नियम", "CSS — रचना आणि कलेक्ट नियम"],
        correct: 0,
      },
],
  ...
  },
  {
    ...
    sections: [
      {
        title: "पुनरावृत्ती — Loops म्हणजे काय?",
        content: "for, while, do-while ने वारंवार केलेले काम; break व continue.\nजे काम पुन्हा-पुन्हा करायचे असते ते loop ने करतात.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "का शिकावे? पुनरावृत्ती — Loops चे फायदे आणि महत्त्व",
        content: "✓ for (सुरुवात; अट; वाढ) च्या तीन भाग:\n• सुरुवात: let i = 1\n• अट: i <= 5 — ही सत्य असताना loop चालतो\n• वाढ: i++ प्रत्येक फेरीनंतर\n'प्रथम अट तपासा, मग block चालवा' हा क्रम महत्त्वाचा.\n✓ do { block } while (अट);\nउपयोग: जेव्हा प्रथम input घेऊनच पुढे ठरवायचे असते — उदा.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
        content: "✗ फक्त वाचून पुढे जाणे — वाचनाने समज राहते पण प्रत्यक्ष सराव न झाल्यास आठवण ठाम होत नाही; प्रत्येक उदाहरण स्वतः रन करा.\n✗ निर्णयात घाई करणे — तपशीलात न जाता निष्कर्ष काढल्यास चुकीचा अर्थ बसतो; प्रत्येक संकल्पना क्रमाक्रमाने तपासा.\n✗ परिणाम/आउटपुट न तपासणे — अपेक्षित उत्तराशी तुमचे उत्तर जुळते आहे का हे पाहूनच पुढे जा.\n✗ सर्व एकाच दिवशी संपवण्याची घाई — छोट्या खंडांमध्ये शिका; ताज्या मनाने केलेला अभ्यास अधिक अचूक होतो.\nप्रत्येक चुकीचा उपाय आधीच वाचल्याने पुढील प्रयोगांमध्ये तुम्हाला ती चुक टाळता येईल.",
...
practiceQuestions: [
      "पुनरावृत्ती — Loops चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "पुनरावृत्ती — Loops वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
      "ह्या धड्यातून तुम्हाला नेमकी कोणती एक गोष्ट नवी समजली ती लिहा.",
    ],    quiz: [
      {
      ...
      {
        question: "ह्या धड्यात मुख्य विषय कोणता?",
        options: ["पुनरावृत्ती — Loops", "Classes - ऑब्जेक्टचे साचे", "print() — output दाखवणे", "विज्ञानातील मजेशीर तथ्य"],
        correct: 0,
      },
],
  ...
  },
  {
    ...
    sections: [
      {
        title: "यादी — Array म्हणजे काय?",
        content: "Array निर्माण, index, length, push/pop, loops सह फिरणे, methods.\nArray म्हणजे एकाच नावात अनेक values — क्रमवार यादी.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
        content: "✗ फक्त वाचून पुढे जाणे — वाचनाने समज राहते पण प्रत्यक्ष सराव न झाल्यास आठवण ठाम होत नाही; प्रत्येक उदाहरण स्वतः रन करा.\n✗ निर्णयात घाई करणे — तपशीलात न जाता निष्कर्ष काढल्यास चुकीचा अर्थ बसतो; प्रत्येक संकल्पना क्रमाक्रमाने तपासा.\n✗ परिणाम/आउटपुट न तपासणे — अपेक्षित उत्तराशी तुमचे उत्तर जुळते आहे का हे पाहूनच पुढे जा.\n✗ सर्व एकाच दिवशी संपवण्याची घाई — छोट्या खंडांमध्ये शिका; ताज्या मनाने केलेला अभ्यास अधिक अचूक होतो.\nप्रत्येक चुकीचा उपाय आधीच वाचल्याने पुढील प्रयोगांमध्ये तुम्हाला ती चुक टाळता येईल.",
...
practiceQuestions: [
      "यादी — Array चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "यादी — Array वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
      "ह्या धड्यातून तुम्हाला नेमकी कोणती एक गोष्ट नवी समजली ती लिहा.",
    ],    quiz: [
      {
      ...
      {
        question: "ह्या धड्यात मुख्य विषय कोणता?",
        options: ["यादी — Array", "Databases - SQLite मध्ये", "Python install करणे", "sticky — चिकट नेव्हिगेशन"],
        correct: 0,
      },
],
  ...
  },
  {
    ...
    sections: [
      {
        title: "Object — गुणधर्म व value म्हणजे काय?",
        content: "Object म्हणजे नाव-value जोड्या; तयार करणे, property बदलणे, methods.\nObject अनेक values एकत्र — पण प्रत्येकाला नाव (key) असते.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "का शिकावे? Object — गुणधर्म व value चे फायदे आणि महत्त्व",
        content: "\"Object — गुणधर्म व value\" हा विषय व्यावहारिक जीवनात आणि पुढील शिक्षणात थेट उपयोगी आहे — म्हणून तो क्रमाक्रमाने नीट समजून घेणे महत्त्वाचे आहे.\nहे शिकल्यानंतर तुम्ही स्वतः छोटी उदाहरणे घडवू शकता आणि याच्या पुढील संकल्पना सहजपणे समजून घेऊ शकता.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
        content: "✗ फक्त वाचून पुढे जाणे — वाचनाने समज राहते पण प्रत्यक्ष सराव न झाल्यास आठवण ठाम होत नाही; प्रत्येक उदाहरण स्वतः रन करा.\n✗ निर्णयात घाई करणे — तपशीलात न जाता निष्कर्ष काढल्यास चुकीचा अर्थ बसतो; प्रत्येक संकल्पना क्रमाक्रमाने तपासा.\n✗ परिणाम/आउटपुट न तपासणे — अपेक्षित उत्तराशी तुमचे उत्तर जुळते आहे का हे पाहूनच पुढे जा.\n✗ सर्व एकाच दिवशी संपवण्याची घाई — छोट्या खंडांमध्ये शिका; ताज्या मनाने केलेला अभ्यास अधिक अचूक होतो.\nप्रत्येक चुकीचा उपाय आधीच वाचल्याने पुढील प्रयोगांमध्ये तुम्हाला ती चुक टाळता येईल.",
...
practiceQuestions: [
      "Object — गुणधर्म व value चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "Object — गुणधर्म व value वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
      "ह्या धड्यातून तुम्हाला नेमकी कोणती एक गोष्ट नवी समजली ती लिहा.",
    ],    quiz: [
      {
      ...
      {
        question: "ह्या धड्यात मुख्य विषय कोणता?",
        options: ["Object — गुणधर्म व value", "Advanced Project - लायब्ररी व्यवस्थापन", "पॉवर सप्लाय सखोल — linear regulator, 7805, buck converter, rails, protection", "App Inventor घटक — button, label, layout व events"],
        correct: 0,
      },
],
