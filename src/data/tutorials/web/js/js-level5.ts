...
export const jsLevel5: Tutorial[] = [
  {
    ...
    sections: [
      {
        title: "जर/तर चा आधार — true आणि false म्हणजे काय?",
        content: "boolean हा निर्णयाचा दगड; तुलना operator बरोबर; falsy values.\nboolean value फक्त दोन प्रकारची: true किंवा false.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "का शिकावे? जर/तर चा आधार — true आणि false चे फायदे आणि महत्त्व",
        content: "\"जर/तर चा आधार — true आणि false\" हा विषय व्यावहारिक जीवनात आणि पुढील शिक्षणात थेट उपयोगी आहे — म्हणून तो क्रमाक्रमाने नीट समजून घेणे महत्त्वाचे आहे.\nहे शिकल्यानंतर तुम्ही स्वतः छोटी उदाहरणे घडवू शकता आणि याच्या पुढील संकल्पना सहजपणे समजून घेऊ शकता.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
...
practiceQuestions: [
      "जर/तर चा आधार — true आणि false चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "जर/तर चा आधार — true आणि false वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
    ...
    
      {
        ...
        options: ["जर/तर चा आधार — true आणि false", "Canvas — रास्टर रेखांकनाचा पाया", "Images - चित्र फाइलला वेबपेजवर आणणे", "Template Literals — ` सह मजकूर"],
        correct: 0,
      },
],
  ...
  },
  {
    ...
    sections: [
      {
        title: "Template Literals — ` सह मजकूर म्हणजे काय?",
        content: "backtick (``) मधे ${} ने variable/expression घातले जाते; multi-line सोपं.\nआतापर्यंत '+' ने string जोडत होतो.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "का शिकावे? Template Literals — ` सह मजकूर चे फायदे आणि महत्त्व",
        content: "✓ \\\"जास्त\\\" : \\\"कमी\\\"} → अगदी if/else\nहे '' आणि \\\"\\\" प्रमाणे safe: आतले विरामचिन्हे वेगळे करण्याची गरज नाही.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
        content: "✗ पण ते वाचायला अवघड होऊ शकतं:\n\\\"नमस्कार \\\" + नाव + \\\", तुमचे \\\" + वय + \\\" वर्षे\\\"\ntemplate literal backtick ` मधे लिहितात आणि ${} मधे variable:\n`नमस्कार ${नाव}, तुमचे ${वय} वर्षे`\nहे सरळ आणि चुकीच्या jागा कमी.\nप्रत्येक चुकीचा उपाय आधीच वाचल्याने पुढील प्रयोगांमध्ये तुम्हाला ती चुक टाळता येईल.",
      },
...
practiceQuestions: [
      "Template Literals — चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "Template Literals — वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
      "ह्या धड्यातून तुम्हाला नेमकी कोणती एक गोष्ट नवी समजली ती लिहा.",
    ],    quiz: [
      {
      ...
      {
        question: "ह्या धड्यात मुख्य विषय कोणता?",
        options: ["Template Literals — ` सह मजकूर", "Sets — अद्वितीय मूल्यांचा संग्रह", "aspect-ratio — प्रमाण जपणे", "इलेक्ट्रिकल मूलभूत माहिती"],
        correct: 0,
      },
],
  ...
  },
  {
    ...
    sections: [
      {
        title: "Math object — गणित म्हणजे काय?",
        content: "round/floor/ceil, random, pow, max/min — अनेक Mathツール.\nतीन गोल करण्याच्या पद्धती:\n• round(4.6) → 5 (जवळचा)\n• floor(4.8) → 4 (नेहमी खाली)\n• ceil(4.2) → 5 (नेहमी वर)\nnegative संख्यांत फरक पडतो:\nfloor(-4.2) → -5 पण round(-4.2) → -4.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "का शिकावे? Math object — गणित चे फायदे आणि महत्त्व",
        content: "\"Math object — गणित\" हा विषय व्यावहारिक जीवनात आणि पुढील शिक्षणात थेट उपयोगी आहे — म्हणून तो क्रमाक्रमाने नीट समजून घेणे महत्त्वाचे आहे.\nहे शिकल्यानंतर तुम्ही स्वतः छोटी उदाहरणे घडवू शकता आणि याच्या पुढील संकल्पना सहजपणे समजून घेऊ शकता.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
        content: "✗ लक्षात ठेवा: हे संपूर्ण random नाही (pseudo), पण सरावासाठी पुरेसे.\nप्रत्येक चुकीचा उपाय आधीच वाचल्याने पुढील प्रयोगांमध्ये तुम्हाला ती चुक टाळता येईल.",
      },
...
practiceQuestions: [
      "Math object — गणित चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "Math object — गणित वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
      "ह्या धड्यातून तुम्हाला नेमकी कोणती एक गोष्ट नवी समजली ती लिहा.",
    ],    quiz: [
      {
      ...
      {
        question: "ह्या धड्यात मुख्य विषय कोणता?",
        options: ["Math object — गणित", "accent-color — चेकबॉक्स रंग", "gap — अंतर विजय", "break, continue, pass — loop नियंत्रण"],
        correct: 0,
      },
],
  ...
  },
  {
    ...
    sections: [
      {
        title: "Classes — object चे ब्ल्यूप्रिंट म्हणजे काय?",
        content: "class template ne अनेक object तयार; constructor, method, this, new.\nआत्तापर्यंत प्रत्येक object स्वतंत्र लिहिला.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "का शिकावे? Classes — object चे ब्ल्यूप्रिंट चे फायदे आणि महत्त्व",
        content: "✓ constructor ला वेगळे नाव देण्याची गरज नाही — class बनवताना तोच मानला जातो.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
        content: "✗ फक्त वाचून पुढे जाणे — वाचनाने समज राहते पण प्रत्यक्ष सराव न झाल्यास आठवण ठाम होत नाही; प्रत्येक उदाहरण स्वतः रन करा.\n✗ निर्णयात घाई करणे — तपशीलात न जाता निष्कर्ष काढल्यास चुकीचा अर्थ बसतो; प्रत्येक संकल्पना क्रमाक्रमाने तपासा.\n✗ परिणाम/आउटपुट न तपासणे — अपेक्षित उत्तराशी तुमचे उत्तर जुळते आहे का हे पाहूनच पुढे जा.\n✗ सर्व एकाच दिवशी संपवण्याची घाई — छोट्या खंडांमध्ये शिका; ताज्या मनाने केलेला अभ्यास अधिक अचूक होतो.\nप्रत्येक चुकीचा उपाय आधीच वाचल्याने पुढील प्रयोगांमध्ये तुम्हाला ती चुक टाळता येईल.",
...
practiceQuestions: [
      "Classes — object चे ब्ल्यूप्रिंट चे थोडक्यात स्पष्टीकरण तुमच्या शब्दांत लिहा.",
      "Classes — object चे ब्ल्यूप्रिंट वर आधारित एक छोटे व्यावहारिक उदाहरण तयार करा व त्याची चाचणी करा.",
      "ह्या धड्यातून तुम्हाला नेमकी कोणती एक गोष्ट नवी समजली ती लिहा.",
    ],    quiz: [
      {
      ...
      {
        question: "ह्या धड्यात मुख्य विषय कोणता?",
        options: ["Classes — object चे ब्ल्यूप्रिंट", "aspect-ratio — प्रमाण नियम", "text-wrap — मजकूर आकार", "Marathi capstone — अंतिम"],
        correct: 0,
      },
],
