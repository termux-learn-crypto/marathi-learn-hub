...
export const jsLevel2: Tutorial[] = [
  {
    ...
    sections: [
      {
        title: "Value ला नाव देणे — let आणि const म्हणजे काय?",
        content: "let/const/var चा फरक, naming नियम, assignment आणि constant value.\nमागील Level मध्ये आपण console.log मधे value थेट छापली.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "का शिकावे? Value ला नाव देणे — let आणि const चे फायदे आणि महत्त्व",
        content: "✓ var फक्त जुना कोड वाचताना ओळखायची गरज आहे — स्वतः लिहिताना let/const वापरा.\n✓ महत्त्वाचा फरक: var function scope वापरतो, let/const block scope.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
...
// let 2नाव = 5;  // चुकीचं — अंकाने सुरूवात नाही`,
  ...
  },
  {
    ...
    sections: [
      {
        title: "Console मध्ये परिणाम कसा दिसतो म्हणजे काय?",
        content: "console.log, console.table, console.error आणि output मधील फरक.\nconsole ही JavaScript ची \\\"दैनंदिनी\\\" आहे — कोड काय करतो ते तिथे नोंदवलं जातं.\nहा धडा हे सोप्या शब्दांत, उदाहरणांसह आणि सरावासहित पूर्ण उलगडतो — आता सुरुवात करूया.",
      },
      {
        title: "का शिकावे? Console मध्ये परिणाम कसा दिसतो चे फायदे आणि महत्त्व",
        content: "✓ ही तपासणी नवशिक्यासाठी महत्त्वाची: values कशा वाटतात — त्या आधी.\nवाचून न थांबता प्रत्येक संकल्पनेचे एक छोटे स्वतःचे उदाहरण प्रयत्न करा — तेव्हाच हा फायदा खऱ्या अर्थाने मिळतो.",
      },
      {
        title: "सामान्य चुका आणि सावधानता",
        content: "✗ फक्त वाचून पुढे जाणे — वाचनाने समज राहते पण प्रत्यक्ष सराव न झाल्यास आठवण ठाम होत नाही; प्रत्येक उदाहरण स्वतः रन करा.\n✗ निर्णयात घाई करणे — तपशीलात न जाता निष्कर्ष काढल्यास चुकीचा अर्थ बसतो; प्रत्येक संकल्पना क्रमाक्रमाने तपासा.\n✗ परिणाम/आउटपुट न तपासणे — अपेक्षित उत्तराशी तुमचे उत्तर जुळते आहे का हे पाहूनच पुढे जा.\n✗ सर्व एकाच दिवशी संपवण्याची घाई — छोट्या खंडांमध्ये शिका; ताज्या मनाने केलेला अभ्यास अधिक अचूक होतो.\nप्रत्येक चुकीचा उपाय आधीच वाचल्याने पुढील प्रयोगांमध्ये तुम्हाला ती चुक टाळता येईल.",
