        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <li><Link href="/courses" className="hover:text-primary-600">अभ्यासक्रम</Link></li>
              <li><Link href="/lessons" className="hover:text-primary-600">सर्व Lessons</Link></li>
              <li><Link href="/roadmaps" className="hover:text-primary-600">शिकण्याचे मार्ग</Link></li>
              <li><Link href="/practice" className="hover:text-primary-600">सराव (Quiz)</Link></li>
              <li><Link href="/challenges" className="hover:text-primary-600">Coding आव्हाने</Link></li>
              <li><Link href="/playground" className="hover:text-primary-600">कोड Playground</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <li><Link href="/terms" className="hover:text-primary-600">वापराच्या अटी</Link></li>
              <li><Link href="/disclaimer" className="hover:text-primary-600">अस्वीकरण</Link></li>
            </ul>
          </div>
        </div>
