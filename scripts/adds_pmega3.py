...
7: m2(
    ['Interactive विस्तार', 'Python आरोही', 'मराठी वेद', 'output दोन'],
    ['दोन पुस्तके.', 'पहिला author.', 'len दोन.', 'verify करा.',],
    ['dataclass खेळ', 'output तपासा'],
    ['अनुभव घ्या.', 'अचूक दिसते.',],
),
8: m2(
    ['Mini प्रोजेक्ट विस्तार', 'book_ids', 'generator क्रम', 'output तीन'],
