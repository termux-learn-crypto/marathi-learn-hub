...
7: m2(
    ['Book वापरा', 'श्रीमान योगी', 'पाने 320', 'output एकत्र'],
    ['दोन गुणधर्म.', 'print दोन.', 'verify करा.', 'practice करा.',],
    ['dataclass खेळ', 'output तपासा'],
    ['अनुभव घ्या.', 'अचूक दिसते.',],
),
8: m2(
    ['Card वापरा', 'आरोही मावळे', 'व्यक्तिगत कार्ड', 'output सरळ'],
