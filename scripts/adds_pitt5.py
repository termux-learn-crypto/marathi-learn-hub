...
AD = {
0: m2(
    ['आज पुढे सरका', 'itertools साधने', 'combinations संच', 'permutations क्रम'],
    ['प्रत्येक शब्द.', 'पुन्हा अभ्यास.', 'practice करा.', 'मनात घट्ट.',],
    ['chain product', 'count islice'],
    ['हेच सार.', 'आज शिकतो.',],
),
1: m2(
    ['जोड्या पुढे', 'combinations', 'permutations', 'तयार मसाला'],
    ['कोणते जोडतात.', 'कोणत्या ठिकाणी.', 'स्वतः लिहू नका.', 'itertools उपयोगी.',],
    ['उपमा पुढे', 'मराठीत समज'],
    ['practice करा.', 'समजून घ्या.',],
),
2: m2(
    ['combinations पुढे', 'permutations पुढे', 'output दोन ओळी', 'verify करा'],
    ['तीन पैकी दोन.', 'दोन पैकी दोन.', 'तुकडे मिळतात.', 'output अचूक.',],
    ['import itertools', 'practice करा'],
    ['अनुभव घ्या.', 'आज उत्तम.',],
),
3: m2(
    ['chain पुढे', 'product पुढे', 'output दोन ओळी', 'verify करा'],
    ['एक दोन तीन चार.', 'a b गुणन.', 'तुकडे क्रमाने.', 'output अचूक.',],
    ['import itertools', 'practice करा'],
    ['समजले का.', 'आज उत्तम.',],
),
4: m2(
    ['count पुढे', 'islice मर्यादा', 'output चार', 'verify करा'],
...
8: m2(
    ['संघ जोड्या पुढे', 'चार खेळाडू', 'सगळ्या जोड्या', 'output सहा ओळी'],
