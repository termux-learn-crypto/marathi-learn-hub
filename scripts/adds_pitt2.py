...
AD = {
0: m2(
    ['itertools पुन्हा', 'साधने चार', 'combinations संच', 'permutations क्रम'],
...
2: m2(
    ['combinations वाचा', 'permutations वाचा', 'output दोन ओळी', 'verify करा'],
    ['तीन पैकी दोन.', 'दोन पैकी दोन.', 'तुकडे मिळतात.', 'output अचूक.',],
    ['import itertools', 'practice करा'],
    ['अनुभव घ्या.', 'आज उत्तम.',],
),
3: m2(
    ['chain वाचा', 'product वाचा', 'output दोन ओळी', 'verify करा'],
    ['एक दोन तीन चार.', 'a b गुणन.', 'तुकडे क्रमाने.', 'output अचूक.',],
    ['import itertools', 'practice करा'],
    ['समजले का.', 'आज उत्तम.',],
),
4: m2(
    ['count वाचा', 'islice मर्यादा', 'output चार', 'verify करा'],
