...
7: m2(
    ['config शेवट', 'mode vol', 'round trip', 'output dict'],
    ['dark mode.', 'vol सत्तर.', 'loads dumps.', 'verify करा.',],
    ['json खेळ', 'output तपासा'],
    ['अनुभव घ्या.', 'अचूक दिसते.',],
),
8: m2(
    ['स्कोअर शेवट', 'आरोही वेद', 'संच dumps', 'output दोन'],
