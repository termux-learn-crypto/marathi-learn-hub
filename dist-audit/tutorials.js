...
const js_level1_1 = require("./tutorials/js-level1");
const js_level2_1 = require("./tutorials/js-level2");
const js_level3_1 = require("./tutorials/js-level3");
const js_level4_1 = require("./tutorials/js-level4");
const js_level5_1 = require("./tutorials/js-level5");
exports.tutorials = [
    // === WEB DEVELOPMENT ===
    {
        slug: "html-basics",
...
console.log(double(5));`,
    ...
    // --- JAVASCRIPT ---
    ...js_level1_1.jsLevel1,
    ...js_level2_1.jsLevel2,
    ...js_level3_1.jsLevel3,
    ...js_level4_1.jsLevel4,
    ...js_level5_1.jsLevel5,
    // === LINUX ===
    {
        slug: "linux-basics",
        categoryId: "linux",
